...
![Wild carrot from a botany textbook according to ChatGPT *\<here I wanted to have an emoji of a [brain](https://emojipedia.org/brain)\>*](images/carrot.webp){fig-align="center" width="500"}
...
-   carrots (medium size) - 2 \<*and here I wanted to add [carrot](https://emojipedia.org/carrot)*\>
